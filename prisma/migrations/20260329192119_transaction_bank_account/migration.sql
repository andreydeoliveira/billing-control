...
INSERT INTO "new_Transaction" ("amountCents", "category", "createdAt", "date", "description", "id", "incomeSourceId", "type", "updatedAt") SELECT "amountCents", "category", "createdAt", "date", "description", "id", "incomeSourceId", "type", "updatedAt" FROM "Transaction";
